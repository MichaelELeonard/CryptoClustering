...
The model was set up using the optimal four clusters, the model was fit to the original scaled data, the model was used to predict the crypto clusters and the information was added to a copy of the original scaled data frame.  The information was then red into a scatter plot to show the results    
<br>
